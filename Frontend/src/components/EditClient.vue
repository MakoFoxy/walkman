                ...
                <v-flex xs12 sm12 md12>
                    <v-card class="elevation-12">
                        <v-toolbar dark color="primary">
                            <v-toolbar-title>Редактирование клиента</v-toolbar-title>
                            <v-spacer></v-spacer>
                        </v-toolbar>
                        <v-card-text>
                            ...
                            <v-flex xs12 sm12 md12>
                                <v-form lazy-validation v-for="(client, index) in organization.clients" v-bind:key="index">
                                    ...
                                    <v-text-field name="password" label="Пароль" type="password"
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn color="primary" @click="editClientButtonClick" :disabled="loadingInProgress">Изменить</v-btn>
    ...
    export default {
        ...
        methods: {
            async editClientButtonClick() {
                ...
                try {
                    await this.axios.put('organizations', this.organization)
                } catch (err) {
        ...
        async beforeMount() {
            ...
            const organizationResponse = await this.axios.get(`organizations/${this.$router.currentRoute.query.id}`);
