...
// Serilog предлагает гибкий и мощный способ логирования для .NET приложений, обеспечивая поддержку множества целевых назначений (так называемых "sinks") и возможности расширенной настройки.0
